...
import SearchForm from "../components/management/device/searchForm";
import AddForm from "../components/management/device/addForm";
import Table from "../components/management/device/table";
...
const TestPage = () => {
  return (
    <DefaoultLayout title="assets" classname="grid">
      <Row gutter={[0, 12]}>
        <h2 style={{ color: "black" }}>단말 개통/등록관리</h2>
        {/* 1. 등록 Form */}
        <Col span={24}>
          <Collapse
